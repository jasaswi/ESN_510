...
if iex ==1
    ...
    xmin = 0; xmax = 4;
    Nsamples = 17; % Number of points for dividing x (N-1 trapezoids)
    ...
    area1 = h/2*(y_sum(1)+y_sum(17)+2*(y_sum(2)+y_sum(3)+y_sum(4)+y_sum(5)+y_sum(6)+y_sum(7)+y_sum(8)+y_sum(9)+y_sum(10)+y_sum(11)+y_sum(12)+y_(13)+y_sum(14)+y_sum(15)+y_sum(16))); % KEY
